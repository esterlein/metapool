...
private:
	...
	template <typename T>
	static constexpr std::size_t get_count()
	{
	...
	template <typename T>
	static constexpr std::size_t get_frames()
	{
	...
	void run_all()
	{
		const std::size_t count  = get_count<T>();
		const std::size_t frames = get_frames<T>();
		...
		Result reserve_pmr = run_reserve_pmr<T>(count, frames);
	...
	template <typename T>
	Result run_emplace_std(std::size_t count, std::size_t)
	{
	...
	template <typename T>
	Result run_emplace_pmr(std::size_t count, std::size_t)
	{
	...
	template <typename T>
	Result run_emplace_mtp(std::size_t count, std::size_t)
	{
	...
	template <typename T>
	Result run_reserve_std(std::size_t count, std::size_t frames)
	{
	...
	template <typename T>
	Result run_reserve_pmr(std::size_t count, std::size_t frames)
	{
		std::cout << "run pmr reserve (size: " << sizeof(T) << ")..." << std::endl;
	...
	template <typename T>
	Result run_reserve_mtp(std::size_t count, std::size_t frames)
	{
	...
	void print_summary(std::span<const BenchmarkEntry> reserve, std::span<const BenchmarkEntry> emplace)
	{
		...
		std::size_t col0 = std::strlen("label");
